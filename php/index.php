...
<head>
  ...
  <title>Welcome to OpenShift - SendGrid</title>
  <style>
  html { 
    background: black;
  }
...
<body>
  <a href="http://openshift.com" class="brand" style="text-align: right">
  ...
  <h1>
    Welcome to OpenShift - SendGrid
  </h1>

  <?php if ($result_decode['message'] == 'success'): ?>
    <h2 style="text-align: center">Congratulations! Your email was sent.</h2>
  <?php else: ?>
    ...
    <p style="font-weight: bold;">
      Please check the folowing steps:
    </p>
    <p>
      1. Edit your username and password in order to send email using SendGrid
    </p>
    <pre>
      $sendgrid = new SendGrid('&lt;sendgrid_username&gt;', '&lt;sendgrid_password&gt;');
    </pre>
    <p>
      2. Please update your email address, subject, text content and html content.
    </p>
    <pre>
      $mail->
          addTo('foo@bar.com')->
